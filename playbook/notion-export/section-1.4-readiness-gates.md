...
> ⚠️ **Operational lesson:** "Lease signed" ≠ "warehouse ready." The readiness gate requires the warehouse to be **racked, stocked, and receiving-ready** — not just leased. Build in at least 2–3 weeks between lease signing and the gate review for buildout, stocking, and verification.
